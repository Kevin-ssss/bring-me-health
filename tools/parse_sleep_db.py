...
def _read_sleep_db_sync() -> ToolResponse:
...
async def read_sleep_db() -> ToolResponse:
    """
    异步工具函数：读取用户睡眠数据并返回 ToolResponse。
    ...
    """
    return await asyncio.to_thread(_read_sleep_db_sync)
